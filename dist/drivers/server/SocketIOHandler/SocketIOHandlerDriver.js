...
var SocketIOHandlerConnection_1 = require("./SocketIOHandlerConnection");
var SocketIOHandlerDriver = /** @class */ (function (_super) {
    __extends(SocketIOHandlerDriver, _super);
    function SocketIOHandlerDriver(port, host, password) {
    ...
    SocketIOHandlerDriver.prototype.start = function () {
    ...
    SocketIOHandlerDriver.prototype.stop = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.server.close();
                return [2 /*return*/];
