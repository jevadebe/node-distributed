...
var SocketIOHandlerConnection = /** @class */ (function (_super) {
    __extends(SocketIOHandlerConnection, _super);
    function SocketIOHandlerConnection(socket, password) {
        var _this = _super.call(this) || this;
        _this.socket = socket;
        _this.password = password;
        socket.on("authenticate", function (p) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
        ...
        socket.on("send", function (m) {
            if (m.event !== "authenticated") {
                _super.prototype.emit.apply(_this, [m.event].concat(m.args));
            }
        });
    ...
    SocketIOHandlerConnection.prototype.emit = function (event) {
        var args = [];
